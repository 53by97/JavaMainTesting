...
public class CopyOfMostImpIntStuffs {
	...
	public static void main(String[] args) {
		CopyOfMostImpIntStuffs object = new CopyOfMostImpIntStuffs();
		System.out.println(object.getiAmAByte()); // output -> 0 // because it
		...
		System.out.println(object.getiAmAByte()); // output -> 127 - 0111 1111
		object.setiAmAByte((byte) (object.getiAmAByte() + 1));
		System.out.println(object.getiAmAByte()); // output -> -128 - 1000 0000
		object.setiAmAByte((byte) (object.getiAmAByte() + 1));
