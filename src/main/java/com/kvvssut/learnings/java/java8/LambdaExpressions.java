...
public class LambdaExpressions {
	...
	public static void main(String[] args) {
		...
		Runnable r2 = () -> {
			...
			System.out
					.println("Java 8 Anonymous Function Way - multiple lines code - Line2!");
		};
		...
		ComplexFunctionalInterfaceWithArguments complexObj = (firstname,
				lastname) -> System.out
				.println("\nComplex functional interface - addName method - resulted name is : "
						+ firstname + " " + lastname);
		...
		/*
		 * Added in Java8 inside Iterable interface, it takes a functional
		 * interface Consumer<? super T> which has a single abstract method
		 * accept(T t)
		 */
	...
	private static void printPersonByPredicate(List<Person> personList,
			Predicate<Person> oldAged) {
	...
	private void sortDataUsingJava8MethodReferences(List<Person> personList) {
		...
		// using java 8 default method printPerson
		personList.forEach(person -> System.out.println(PersonInterface
				.printStatic(person)));
